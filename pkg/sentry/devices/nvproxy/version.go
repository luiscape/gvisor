		...
		v535_104_05 := func() *driverABI {
			...
			return &driverABI{
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV2080_CTRL_CMD_FB_GET_FS_INFO:                                   ctrlHandler(rmControlSimple, compUtil),
				...
				allocationClass: map[nvgpu.ClassID]allocationClassHandler{
					...
					nvgpu.MAXWELL_PROFILER:           allocHandler(rmAllocSimple[nvgpu.NVB2CC_ALLOC_PARAMETERS], nvconf.CapProfiling),
				...
				getInfo: func() *DriverABIInfo {
					return &DriverABIInfo{
						...
						AllocationInfos: map[nvgpu.ClassID]IoctlInfo{
							...
							nvgpu.MAXWELL_PROFILER:           ioctlInfo("MAXWELL_PROFILER", nvgpu.NVB2CC_ALLOC_PARAMETERS{}),
