...
func Init() {
	abisOnce.Do(func() {
		...
		v535_104_05 := addUnsupportedDriverABI(535, 104, 05, func() *driverABI {
			...
			return &driverABI{
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV00FD_CTRL_CMD_ATTACH_MEM:                                       ctrlHandler(ctrlMemoryMulticastFabricAttachMem, compUtil),
					nvgpu.NV00FD_CTRL_CMD_DETACH_MEM:                                       ctrlHandler(ctrlMemoryMulticastFabricDetachMem, compUtil),
					...
					nvgpu.NV0000_CTRL_CMD_OS_UNIX_EXPORT_OBJECT_TO_FD:                      ctrlHandler(ctrlClientExportObjectToFD, compUtil),
					...
					nvgpu.NV0000_CTRL_CMD_OS_UNIX_GET_EXPORT_OBJECT_INFO:                   ctrlHandler(ctrlOSUnixGetExportObjectInfo[nvgpu.NV0000_CTRL_OS_UNIX_GET_EXPORT_OBJECT_INFO_PARAMS], compUtil),
					nvgpu.NV0000_CTRL_CMD_OS_UNIX_EXPORT_OBJECTS_TO_FD:                     ctrlHandler(ctrlClientExportObjectsToFD, compUtil),
				...
				getInfo: func() *DriverABIInfo {
					return &DriverABIInfo{
						...
						ControlInfos: map[uint32]IoctlInfo{
							...
							nvgpu.NV00FD_CTRL_CMD_GET_INFO:                                         ioctlInfo("NV00FD_CTRL_CMD_GET_INFO", nvgpu.NV00FD_CTRL_GET_INFO_PARAMS{}),
							nvgpu.NV00FD_CTRL_CMD_ATTACH_MEM:                                       ioctlInfo("NV00FD_CTRL_CMD_ATTACH_MEM", nvgpu.NV00FD_CTRL_ATTACH_MEM_PARAMS{}),
							nvgpu.NV00FD_CTRL_CMD_DETACH_MEM:                                       ioctlInfo("NV00FD_CTRL_CMD_DETACH_MEM", nvgpu.NV00FD_CTRL_DETACH_MEM_PARAMS{}),
		...
		v545_23_06 := addUnsupportedDriverABI(545, 23, 06, func() *driverABI {
			abi := v535_113_01()
			abi.controlCmd[nvgpu.NV0000_CTRL_CMD_OS_UNIX_GET_EXPORT_OBJECT_INFO] = ctrlHandler(ctrlOSUnixGetExportObjectInfo[nvgpu.NV0000_CTRL_OS_UNIX_GET_EXPORT_OBJECT_INFO_PARAMS_V545], compUtil)
		...
		_ = addDriverABI(620, 6, 0, ChecksumNoDriver, "95b94e43fd0cb0fb409fd523be491ac7248fec6d1cf82543fa4119cdcbad05b3", func() *driverABI {
			...
			abi.controlCmd[nvgpu.NV2080_CTRL_CMD_NVLINK_GET_UPDATE_NVLE_LIDS_V3] = ctrlHandler(rmControlSimple, nvconf.CapFabricIMEXManagement)
