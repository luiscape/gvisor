		...
		v535_104_05 := addUnsupportedDriverABI(535, 104, 05, func() *driverABI {
			...
			return &driverABI{
				...
				allocationClass: map[nvgpu.ClassID]allocationClassHandler{
					...
					nvgpu.NV_EVENT_BUFFER:            allocHandler(rmAllocSimple[nvgpu.NV_EVENT_BUFFER_ALLOC_PARAMETERS], nvconf.CapProfiling),
					nvgpu.NV_EVENT_BUFFER_BIND:       allocHandler(rmAllocSimple[nvgpu.NV_EVENT_BUFFER_BIND_PARAMETERS], nvconf.CapProfiling),
				...
				getInfo: func() *DriverABIInfo {
					return &DriverABIInfo{
						...
						ControlInfos: map[uint32]IoctlInfo{
							...
							nvgpu.NV_EVENT_BUFFER_CTRL_CMD_FLUSH:                                   simpleIoctlInfo("NV_EVENT_BUFFER_CTRL_CMD_FLUSH"),
						...
						AllocationInfos: map[nvgpu.ClassID]IoctlInfo{
							...
							nvgpu.NV_EVENT_BUFFER_BIND:       ioctlInfo("NV_EVENT_BUFFER_BIND", nvgpu.NV_EVENT_BUFFER_BIND_PARAMETERS{}),
