...
// From src/common/sdk/nvidia/inc/ctrl/ctrl90cd.h.
const (
	NV_EVENT_BUFFER_CTRL_CMD_ENABLE_EVENTS = 0x90cd0101
	NV_EVENT_BUFFER_CTRL_CMD_UPDATE_GET    = 0x90cd0102
	NV_EVENT_BUFFER_CTRL_CMD_FLUSH         = 0x90cd0104
)
...
const (
	...
	NV2080_CTRL_CMD_NVLINK_GET_UPDATE_NVLE_LIDS_V3   = 0x208030a3
)
